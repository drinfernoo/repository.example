...
The `repo_xml_generator.py` **must be run** using Python 2.7.x, and **is not** compatible with Python 3 or higher. You can download the latest release of Python 2.7 [here](https://www.python.org/downloads/release/python-2715/).
